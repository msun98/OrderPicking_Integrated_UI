...
QT_MOC_LITERAL(1, 5, 16), // "SIGNAL_LOG_WRITE"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "onStatCheck"
QT_MOC_LITERAL(4, 35, 14) // "onReadyCmdRead"

    },
    "lift\0SIGNAL_LOG_WRITE\0\0onStatCheck\0"
    "onReadyCmdRead"
};
...
void lift::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (lift::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&lift::SIGNAL_LOG_WRITE)) {
                *result = 0;
                return;
            }
        }
